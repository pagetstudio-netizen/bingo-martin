import{c as V,a as I,b as Q,u as W,d as B,r as u,j as e,L as C,f as O,q as g,e as b}from"./index-IWO-0GZ9.js";import{u as S}from"./useQuery-CQ9u_26K.js";import{u as j}from"./useMutation-BniFcgVK.js";import{u as H,t as U,o as X,s as y}from"./types-chzhiAZu.js";import{a as _}from"./countries-DOninoG6.js";import{e as G}from"./illustration-8_1784762965573-C2eE_S1I.js";import{C as E}from"./chevron-left-D3cHVK-5.js";import{C as $}from"./chevron-right-D5u7ctoK.js";import{X as J}from"./x-B-D_H2Kz.js";import{S as Y}from"./search-BjrU7CCL.js";import{C as L}from"./check-BwrywIB5.js";import{P as Z,S as ee,T as te}from"./trash-2-C-Ow5oC9.js";const ae=V("CreditCard",[["rect",{width:"20",height:"14",x:"2",y:"5",rx:"2",key:"ynyp8z"}],["line",{x1:"2",x2:"22",y1:"10",y2:"10",key:"1b3vmo"}]]),re=X({accountName:y().min(2,"Nom du titulaire requis"),accountNumber:y().min(8,"Numéro requis"),paymentMethod:y().min(2,"Moyen de paiement requis")}),r="#b10813";function we(){const{user:m}=I(),{toast:i}=Q(),[,M]=W(),P=B(),l=new URLSearchParams(P).get("from")==="withdrawal",[F,n]=u.useState(!1),[q,c]=u.useState(!1),[p,f]=u.useState(""),[x,d]=u.useState(""),{data:h,isLoading:z}=S({queryKey:["/api/wallets"]}),{data:T=[]}=S({queryKey:["/api/countries"]}),s=H({resolver:U(re),defaultValues:{accountName:"",accountNumber:"",paymentMethod:""}}),w=j({mutationFn:async t=>{const a=await b("POST","/api/wallets",{...t,country:m.country});if(!a.ok){const o=await a.json();throw new Error(o.message||"Erreur")}return a.json()},onSuccess:()=>{g.invalidateQueries({queryKey:["/api/wallets"]}),i({title:"Portefeuille ajouté !"}),s.reset(),f(""),n(!1)},onError:t=>{i({title:"Erreur",description:t.message,variant:"destructive"})}}),N=j({mutationFn:async t=>{const a=await b("DELETE",`/api/wallets/${t}`,{});if(!a.ok){const o=await a.json();throw new Error(o.message||"Erreur")}return a.json()},onSuccess:()=>{g.invalidateQueries({queryKey:["/api/wallets"]}),i({title:"Portefeuille supprimé !"})},onError:t=>{i({title:"Erreur",description:t.message,variant:"destructive"})}}),k=j({mutationFn:async t=>{const a=await b("PATCH",`/api/wallets/${t}/default`,{});if(!a.ok){const o=await a.json();throw new Error(o.message||"Erreur")}return a.json()},onSuccess:()=>{g.invalidateQueries({queryKey:["/api/wallets"]})},onError:t=>{i({title:"Erreur",description:t.message,variant:"destructive"})}}),A=t=>{l&&(localStorage.setItem("selectedWalletId",t.id.toString()),M("/withdrawal"))},D=t=>{f(t),s.setValue("paymentMethod",t),d(""),c(!1)},R=()=>{s.handleSubmit(t=>w.mutate(t))()};if(!m)return null;const v=_(m.country,T),K=l?"/withdrawal":"/account";return F?e.jsxs("div",{className:"wallet-page wallet-form-page flex min-h-full flex-col",children:[e.jsx("style",{children:`
          .wallet-form-page {
            min-height: 100dvh;
