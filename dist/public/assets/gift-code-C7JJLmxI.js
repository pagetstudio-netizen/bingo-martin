import{a as p,b as x,r as h,j as e,f as m,L as u,e as b}from"./index-IWO-0GZ9.js";import{u as j}from"./useQuery-CQ9u_26K.js";import{u as w}from"./useMutation-BniFcgVK.js";import{C as y}from"./chevron-left-D3cHVK-5.js";import{C as k}from"./chevron-right-D5u7ctoK.js";const v="/assets/70df605a42dc9ac4254ef5fd2de61af4_1790106066950-ZA0zkBlV.jpg",z="/assets/tg-1_1787390593655-7lN49whF.png",i="#b10813";function P(){const{refreshUser:c}=p(),{toast:r}=x(),[a,o]=h.useState(""),{data:f}=j({queryKey:["/api/settings"]}),g=f?.groupLabel||"Groupe Telegram officiel",n=w({mutationFn:async t=>{const s=await b("POST","/api/gift-codes/claim",{code:t});if(!s.ok){const l=await s.json();throw new Error(l.message||"Erreur")}return s.json()},onSuccess:t=>{c(),o(""),r({title:"Félicitations !",description:t.message})},onError:t=>{r({title:"Erreur",description:t.message,variant:"destructive"})}}),d=()=>{if(!a.trim()){r({title:"Erreur",description:"Veuillez saisir un code",variant:"destructive"});return}n.mutate(a.trim())};return e.jsxs("main",{className:"gift-reference",children:[e.jsx("style",{children:`
