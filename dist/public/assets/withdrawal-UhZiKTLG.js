import{a as M,b as q,G as P,r as l,u as T,j as e,L as k,f as j,e as V}from"./index-DchUCKwv.js";import{u as x}from"./useQuery-BaGGPzFw.js";import{u as $}from"./useMutation-C9fXPjt-.js";import{g as O}from"./countries-DOninoG6.js";import{T as D}from"./trending-up-62ZbvoPX.js";import{C as K}from"./credit-card-PKH5n5Vw.js";import{C as Q}from"./chevron-right-Bm0l8Wg9.js";const X="/assets/t%C3%A9l%C3%A9chargement_(80)_1787363581764-DIwCG-l1.png",_="/assets/70df605a42dc9ac4254ef5fd2de61af4_1790106066950-ZA0zkBlV.jpg";function te(){const{user:d,refreshUser:z}=M(),{toast:a}=q(),N=P(),[n,u]=l.useState(""),[t,g]=l.useState(null),[,C]=T(),b=(d?O(d.country):null)?.currency||"XOF",h=b==="FCFA"?"XOF":b,{data:s}=x({queryKey:["/api/settings/withdrawal"],staleTime:0,refetchOnMount:!0}),p=s?.minWithdrawal??1500,w=s?.withdrawalFees??18,m=s?.withdrawalStartHour??9,y=s?.withdrawalEndHour??17,F=n?Math.floor(Number(n)*(1-w/100)):0,v=new Date().getHours(),I=v>=m&&v<y,{data:i=[],isLoading:S}=x({queryKey:["/api/wallets"],refetchOnWindowFocus:!0}),{data:L=[]}=x({queryKey:["/api/user/products"]}),W=L.some(r=>r.status==="active");l.useEffect(()=>{const r=localStorage.getItem("selectedWalletId");if(r&&i.length>0){const o=i.find(E=>E.id===parseInt(r));o&&g(o),localStorage.removeItem("selectedWalletId")}},[i]),l.useEffect(()=>{if(!t&&i.length>0){const r=i.find(o=>o.isDefault);r&&g(r)}},[i,t]);const f=$({mutationFn:async r=>(await V("POST","/api/withdrawals",r)).json(),onSuccess:()=>{a({title:"Demande envoyée",description:"Votre demande de retrait a été envoyée."}),z(),N.invalidateQueries({queryKey:["/api/withdrawals"]}),u("")},onError:r=>{a({title:"Erreur",description:r.message,variant:"destructive"})}}),A=()=>{if(!I){a({title:"Horaires de retrait",description:`Les retraits sont disponibles de ${m}h à ${y}h`,variant:"destructive"});return}if(!W){a({title:"Produit requis",description:"Vous devez avoir un produit actif pour effectuer un retrait",variant:"destructive"});return}if(!n||n<p){a({title:"Montant invalide",description:`Le montant minimum est de ${p} ${h}`,variant:"destructive"});return}if(!t){a({title:"Compte requis",description:"Veuillez sélectionner un compte bancaire",variant:"destructive"});return}f.mutate({amount:Number(n),walletId:t.id})};if(S)return e.jsx("div",{className:"min-h-screen bg-white flex items-center justify-center",children:e.jsx(k,{className:"w-8 h-8 animate-spin text-[#c8102e]"})});if(!d)return null;const H=parseFloat(d?.balance||"0"),R=i.length>0,c=h==="XOF"?"FCFA":h;return e.jsxs("main",{className:"withdraw-reference min-h-screen bg-[#f7f4f2]",children:[e.jsx("style",{children:`
        .withdraw-reference {
          color: #151515;
      ...
      `}),e.jsxs("div",{className:"withdraw-screen",children:[e.jsxs("section",{className:"withdraw-hero","aria-label":"Retrait",children:[e.jsx("div",{className:"hero-art",style:{backgroundImage:`url(${_})`},"aria-hidden":"true",children:e.jsx("span",{className:"receipt-icon"})}),e.jsx("h1",{className:"withdraw-title",children:"RETRAIT"}),e.jsx(j,{href:"/history",children:e.jsx("button",{className:"history-button","aria-label":"Historique des transactions",children:e.jsx("span",{className:"history-icon","aria-hidden":"true"})})}),e.jsx(j,{href:"/account",children:e.jsx("button",{className:"withdraw-back","data-testid":"button-back","aria-label":"Retour"})}),e.jsxs("div",{className:"balance-card",children:[e.jsx("p",{className:"balance-label",children:"Solde du compte"}),e.jsxs("p",{className:"balance-value","data-testid":"text-balance",children:[e.jsx(D,{className:"balance-trend","aria-hidden":"true"}),e.jsx("span",{children:c}),Math.round(H).toLocaleString("fr-FR")]}),e.jsx("div",{className:"wallet-mark","aria-hidden":"true",children:e.jsx("img",{src:X,alt:""})})]})]}),e.jsxs("section",{className:"wallet-panel","aria-label":"Portefeuille de retrait",children:[e.jsx("p",{className:"wallet-label",children:"Veuillez sélectionner votre carte bancaire"}),e.jsxs("button",{onClick:()=>C(R?"/wallet?from=withdrawal":"/wallet"),className:"wallet-choice","data-testid":"button-select-wallet",children:[e.jsx(K,{"aria-hidden":"true"}),e.jsx("span",{className:"wallet-copy",children:t?`${t.accountName} · ${t.accountNumber}`:"Choisissez votre portefeuille"}),e.jsx(Q,{"aria-hidden":"true"})]})]}),e.jsxs("section",{className:"amount-panel","aria-label":"Montant de retrait",children:[e.jsx("p",{className:"amount-label",children:"Entrez le montant de retrait"}),e.jsxs("label",{className:"amount-field",children:[e.jsx("span",{className:"amount-currency",children:c}),e.jsx("input",{type:"number",value:n,onChange:r=>u(r.target.value?Number(r.target.value):""),placeholder:"Veuillez saisir le montant de retrait","data-testid":"input-withdrawal-amount","aria-label":"Montant de retrait"})]}),e.jsxs("div",{className:"amount-details",children:[e.jsxs("span",{children:["Montant reçu : ",c," ",F.toLocaleString("fr-FR")]}),e.jsxs("span",{children:["Taux de frais : ",w.toFixed(0),"%"]})]})]}),e.jsx("button",{onClick:A,disabled:f.isPending,className:"submit","data-testid":"button-submit-withdrawal",children:f.isPending?e.jsx(k,{className:"h-5 w-5 animate-spin"}):"Confirmer"}),e.jsxs("section",{className:"instructions","aria-label":"Instructions de retrait",children:[e.jsx("h2",{className:"instructions-title",children:"Instructions de Retrait :"}),e.jsxs("p",{className:"instruction",children:[e.jsx("strong",{children:"Montant minimum de retrait :"})," ",p.toLocaleString("fr-FR")," ",c,"."]}),e.jsx("p",{className:"instruction",children:e.jsxs("strong",{children:["Les frais de retrait s'élèvent à ",w," % du montant retiré."]})}),e.jsxs("p",{className:"instruction",children:[e.jsx("strong",{children:"Vous pouvez effectuer des retraits à tout moment."})," Les retraits sont disponibles sous 2 à 24 heures."]}),e.jsx("p",{className:"instruction",children:"Vérifiez vos informations de portefeuille avant de confirmer."})]})]})]})}export{te as default};
