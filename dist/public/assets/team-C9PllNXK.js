import{a as h,r as f,j as e,L as u}from"./index-CwW_ncts.js";import{u as n}from"./useQuery-CK-f9vTw.js";import{b as v}from"./logo-1_1790106035177-BcMb50Rj.js";import{e as j}from"./05b94578-92ae-48a6-b863-59d59ee49423_1790114751100-BgIRbjFg.js";const d=["LV:1","LV:2","LV:3"];function o(t){return`${Number(t||0).toLocaleString("fr-FR")} FCFA`}function w(t){return t.length<=4?t:t.length>8?`${t.slice(0,3)}*****${t.slice(-6)}`:`${t.slice(0,2)}****${t.slice(-2)}`}function N(t){const i=new Date(t);return Number.isNaN(i.getTime())?"-":i.toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function $(){const{user:t}=h(),[i,c]=f.useState(0),{data:l,isLoading:p}=n({queryKey:["/api/team/stats"]}),{data:m,isLoading:b}=n({queryKey:["/api/team/details"]});if(!t)return null;const r=[m?.level1||[],m?.level2||[],m?.level3||[]][i],x=(l?.level1Count||0)+(l?.level2Count||0)+(l?.level3Count||0),g=p||b;return e.jsxs("main",{className:"team-mobile",children:[e.jsx("style",{children:`
        .team-mobile {
          min-height: 100dvh;
          padding-bottom: 59px;
          overflow-x: hidden;
      ...
      `}),e.jsxs("div",{className:"team-screen",children:[e.jsx("header",{className:"team-appbar",children:"Team"}),e.jsxs("section",{className:"team-hero","aria-label":"Statistiques de l'équipe",children:[e.jsx("img",{className:"team-hero-art",src:"/bingo-home-banner.png",alt:""}),e.jsxs("div",{className:"team-stat-panel",children:[e.jsxs("div",{className:"team-stat",children:[e.jsx("span",{className:"team-stat-label",children:"Team Recharge"}),e.jsx("strong",{className:"team-stat-value",children:o(l?.teamRecharge)})]}),e.jsxs("div",{className:"team-stat",children:[e.jsx("span",{className:"team-stat-label",children:"Team size"}),e.jsx("strong",{className:"team-stat-value",children:x})]})]})]}),e.jsx("section",{className:"level-switch","aria-label":"Niveaux des filleuls",children:d.map((a,s)=>e.jsx("button",{type:"button",className:`level-button ${i===s?"active":""}`,onClick:()=>c(s),"data-testid":`team-level-${s+1}`,children:a},a))}),e.jsx("section",{className:"members","aria-label":`Filleuls ${d[i]}`,children:g?e.jsx("div",{className:"loading",children:e.jsx(u,{className:"animate-spin","aria-label":"Chargement"})}):r.length===0?e.jsx("div",{className:"no-data",children:e.jsx("img",{src:j,alt:"Aucune donnée disponible"})}):r.map(a=>e.jsxs("article",{className:"member-card",children:[e.jsx("div",{className:"member-logo",children:e.jsx("img",{src:v,alt:""})}),e.jsxs("div",{className:"member-info",children:[e.jsxs("p",{className:"member-phone",children:["Téléphone mobile : ",w(a.phone)]}),e.jsxs("div",{className:"member-row",children:[e.jsxs("span",{children:["Dépôt : ",o(a.totalDeposited)]}),e.jsxs("span",{children:["Retrait : ",o(a.totalWithdrawn)]})]}),e.jsxs("p",{className:"member-time",children:["Heure : ",N(a.createdAt)]})]}),a.hasPurchasedProduct&&e.jsx("span",{className:"member-status",children:"Acheté"})]},a.id))})]})]})}export{$ as default};
