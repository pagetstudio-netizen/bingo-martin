import{a as d,b as p,j as e}from"./index-CwW_ncts.js";import{u as m}from"./useQuery-CK-f9vTw.js";import{b as x}from"./logo-1_1790106035177-BcMb50Rj.js";import{C as h}from"./copy-DVu01v3I.js";function y(){const{user:r}=d(),{toast:t}=p(),{data:s}=m({queryKey:["/api/settings"]});if(!r)return null;const a=r.referralCode,n=`${window.location.origin}/invitation?code=${encodeURIComponent(a)}`,c=[s?.level1Commission||"25",s?.level2Commission||"3",s?.level3Commission||"2"],l=async(o,i)=>{try{await navigator.clipboard.writeText(o),t({title:`${i} copié`})}catch{t({title:"Copie impossible",description:"Sélectionnez le texte pour le copier."})}};return e.jsxs("main",{className:"share-mobile",children:[e.jsx("style",{children:`
        .share-mobile {
          min-height: 100dvh;
          padding-bottom: 59px;
          overflow-x: hidden;
