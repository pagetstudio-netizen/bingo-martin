import{c as M,j as e,L,a as _,u as Q,b as B,r as u,q as j,e as C}from"./index-QIFCPOZ8.js";import{u as y}from"./useQuery-BR0COp6B.js";import{u as $}from"./useMutation-DVBnge2q.js";import{p as K}from"./70df605a42dc9ac4254ef5fd2de61af4_1790106066950-BcpDJ99p.js";import{p as W,a as H,b as J,c as G,d as U,e as V}from"./a61f6f9a0bd34ce80a06f7b1c72059bd_1790106066849-mubT9n_B.js";import{p as O}from"./9c7951043ab6fc2cbf52f3d7867b910c_1790106066758-CcZwlytQ.js";import{b as X}from"./logo-1_1790106035177-BcMb50Rj.js";import{X as Y}from"./x-B6HI6-nN.js";const Z=M("CalendarCheck2",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["path",{d:"M21 14V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8",key:"bce9hv"}],["path",{d:"M3 10h18",key:"8toen8"}],["path",{d:"m16 20 2 2 4-4",key:"13tcca"}]]);function z(n,r){return`${Number(n||0).toLocaleString("fr-FR")} ${r}`}function ee({product:n,currency:r="FCFA",pending:c=!1,onCancel:d,onConfirm:s}){return e.jsx("div",{className:"fixed inset-0 z-[70] flex items-center justify-center bg-black/50 px-5",role:"presentation",onClick:d,children:e.jsxs("div",{className:"w-full max-w-[428px] overflow-hidden rounded-[5px] bg-white shadow-2xl",role:"dialog","aria-modal":"true","aria-labelledby":"purchase-confirm-title",onClick:p=>p.stopPropagation(),children:[e.jsx("h2",{id:"purchase-confirm-title",className:"border-b border-[#ece8e4] px-5 py-5 text-center text-[23px] font-bold leading-tight text-[#1e1e1e]",children:n.name}),e.jsxs("div",{className:"px-7 py-7",children:[e.jsx("p",{className:"text-[18px] leading-[1.55] text-[#302d2d]",children:"Êtes-vous sûr de vouloir acheter ce produit ?"}),e.jsxs("ul",{className:"mt-5 space-y-4 text-[18px] leading-none text-[#302d2d]",children:[e.jsxs("li",{className:"flex items-center gap-3",children:[e.jsx("span",{"aria-hidden":"true",className:"text-[22px] leading-none",children:"•"}),e.jsxs("span",{children:["Prix :"," ",e.jsx("strong",{className:"font-bold text-[#ad0b15]",children:z(n.price,r)})]})]}),e.jsxs("li",{className:"flex items-center gap-3",children:[e.jsx("span",{"aria-hidden":"true",className:"text-[22px] leading-none",children:"•"}),e.jsxs("span",{children:["Total profit :"," ",e.jsx("strong",{className:"font-bold text-[#ad0b15]",children:z(n.totalReturn,r)})]})]})]})]}),e.jsxs("div",{className:"flex h-[70px] border-t border-[#ece8e4]",children:[e.jsx("button",{type:"button",className:"flex-1 border-r border-[#ece8e4] text-[20px] font-semibold text-[#252525] transition-colors hover:bg-[#faf7f7] active:bg-[#f3eeee]",onClick:d,"data-testid":"button-cancel-home-purchase",children:"Annuler"}),e.jsx("button",{type:"button",className:"flex-1 text-[20px] font-bold text-[#ad0b15] transition-colors hover:bg-[#fff7f7] active:bg-[#fbeaea] disabled:cursor-not-allowed disabled:opacity-60",onClick:s,disabled:c,"data-testid":"button-confirm-home-purchase",children:c?e.jsx(L,{className:"mx-auto h-5 w-5 animate-spin"}):"Confirmer"})]})]})})}const oe="/assets/icon_1_1790113934821-QPC_AXQK.png",te="/assets/icon_2_1790113934863-5P0dCuiG.png",ie="/assets/icon_3-1_1790113934921-Cfp6Mbtn.png",ne="/assets/05b94578-92ae-48a6-b863-59d59ee49423_1790114751100-B5e5EGjW.png",a="#ad0b15",ae="/bingo-home-banner.png",re=[{label:"Dépôt",href:"/deposit",image:oe},{label:"Retrait",href:"/withdrawal",image:te},{label:"Check-in",href:"/checkin",icon:Z},{label:"Service client",href:"/service",image:ie,round:!0}],x=[K,W,H,J,G,U,O,V];function v(n){return`${Number(n||0).toLocaleString("fr-FR")} FCFA`}function P(n){if(!n)return"—";const r=new Date(n);return Number.isNaN(r.getTime())?"—":r.toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function se(n,r){const c=new Date(n||r);return Number.isNaN(c.getTime())?null:new Date(c.getTime()+1440*60*1e3)}function be(){const{user:n,refreshUser:r}=_(),[,c]=Q(),{toast:d}=B(),[s,p]=u.useState("available"),[b,m]=u.useState(null),{data:A,isLoading:F}=y({queryKey:["/api/products"]}),{data:E,isLoading:I}=y({queryKey:["/api/user/products"]}),{data:f}=y({queryKey:["/api/settings/links"]}),[R,h]=u.useState(!1);u.useEffect(()=>{const o=()=>h(!0);return o(),window.addEventListener("home-tab-clicked",o),()=>window.removeEventListener("home-tab-clicked",o)},[]);const k=$({mutationFn:async o=>{const t=await C("POST",`/api/products/${o}/purchase`,{});if(!t.ok){const i=await t.json();throw new Error(i.message||"Erreur lors de l'achat")}return t.json()},onSuccess:()=>{j.invalidateQueries({queryKey:["/api/products"]}),j.invalidateQueries({queryKey:["/api/user/products"]}),r(),m(null),d({title:"Produit acheté !",description:"Vous commencerez à recevoir des gains demain."})},onError:o=>{m(null),d({title:"Erreur",description:o.message,variant:"destructive"})}}),D=$({mutationFn:async o=>{const t=await C("POST",`/api/products/${o}/claim-free`,{});if(!t.ok){const i=await t.json();throw new Error(i.message||"Impossible de réclamer ce produit")}return t.json()},onSuccess:()=>{j.invalidateQueries({queryKey:["/api/products"]}),r(),d({title:"Bonus réclamé",description:"Le bonus gratuit a été ajouté à votre compte."})},onError:o=>{d({title:"Erreur",description:o.message,variant:"destructive"})}});if(!n)return null;const N=A||[],S=s==="available"?F:I,T=(o,t)=>{if(o==="Service client"){const i=f?.supportLink?.trim();i&&window.open(i,"_blank","noopener,noreferrer");return}c(t)};return e.jsxs("main",{className:"bingo-home",children:[e.jsx("style",{children:`
        .bingo-home {
          min-height: 100dvh;
          padding: 22px 0 76px;
          overflow-x: hidden;
...
Level 1: 25%
Level 2: 3%
Level 3: 2%`}),e.jsx("button",{type:"button",className:"welcome-group-button",onClick:()=>{window.open(f.groupLink,"_blank","noopener,noreferrer"),h(!1)},"data-testid":"button-welcome-group",children:"Join the group"})]})]})}),b&&e.jsx(ee,{product:b,currency:"FCFA",pending:k.isPending,onCancel:()=>m(null),onConfirm:()=>k.mutate(b.id)})]})}export{be as default};
