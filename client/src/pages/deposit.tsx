  ...
  if (step === "amount") return (
    <main className="recharge-reference min-h-screen bg-[#f7f3f0]">
      <style>{`
        ...
        .recharge-reference .country-field {
          margin-top: 16px;
        }
        ...
        .recharge-reference .tutorial svg {
          color: #050505;
        }
        .recharge-reference .reminder {
          margin-top: 19px;
          border-radius: 6px;
          padding: 16px 12px;
          color: #432121;
        ...
        .recharge-reference .reminder strong {
          display: block;
          margin-bottom: 7px;
          font-size: 16px;
        }
        @media (max-width: 360px) {
          .recharge-reference .amount-panel { margin-right: 14px; margin-left: 14px; padding-right: 14px; padding-left: 14px; }
          .recharge-reference .preset-row { gap: 12px; }
          .recharge-reference .preset { height: 56px; font-size: 16px; }
          .recharge-reference .balance-card,
      ...
      <div className="recharge-screen">
        <section className="recharge-hero" aria-label="Recharger">
          ...
          <h1 className="recharge-title">Recharger</h1>
        </section>

        <section className="balance-card" aria-label="Solde actuel">
          <span className="balance-label">Solde</span>
          <strong className="balance-value">
            {Number(user.balance || 0).toLocaleString("fr-FR")} {currency}
          </strong>
        </section>

        <section className="amount-panel" aria-label="Montant de recharge">
          <div className="preset-row">
            {[3000, 5000, 10000, 20000, 50000, 100000, 300000, 500000, 1000000].map((preset) => (
              <button
                key={preset}
        ...
        <section className="instructions" aria-label="Instructions de recharge">
          <button type="button" className="tutorial" onClick={() => toast({ title: "Tutoriel de recharge", description: "Suivez les étapes affichées après avoir choisi votre pays." })}>
            <span>Vérifier le tutoriel en vidéo</span>
            <ArrowRight className="h-5 w-5" />
          </button>
          <div className="reminder">
            <strong>Rappel</strong>
            <span>
              Le montant minimum est de {MIN_DEPOSIT.toLocaleString("fr-FR")} {currency}. Vérifiez attentivement les informations de paiement et patientez 10 à 30 minutes après votre virement.
            </span>
          </div>
        </section>
      </div>
