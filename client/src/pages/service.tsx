...
import serviceImage from "@assets/9c7951043ab6fc2cbf52f3d7867b910c_1790106066758.jpg";
import bingoLogo from "@assets/logo-1_1790106035177.png";
import bingoBrandBanner from "@assets/70df605a42dc9ac4254ef5fd2de61af4_1790106066950.jpg";
    ...
    <main className="service-reference">
      ...
      <div className="service-screen">
        <header className="service-header">
          ...
          <img className="service-logo" src={bingoLogo} alt="Logo Bingo" />
          <h1 className="service-title">Service client</h1>
        </header>

        <section className="benefits" aria-label="Nos garanties">
          <img className="benefit-banner" src={bingoBrandBanner} alt="Bingo" />
        </section>
        ...
        <section className="telegram-section" aria-labelledby="telegram-heading">
          ...
          <div className="telegram-grid">
            <img className="bike-image" src={serviceImage} alt="Service client Bingo" />
