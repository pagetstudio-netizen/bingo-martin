...
import bingoHero from "@assets/70df605a42dc9ac4254ef5fd2de61af4_1790106066950.jpg";
  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-50">
      ...
      <div className="relative overflow-hidden" style={{ height: "260px" }}>
        <img
          src={bingoHero}
          alt="Chips Bingo saveur tomate"
          className="w-full h-full object-cover object-center"
        />
        {/* Dark gradient overlay */}
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to bottom, rgba(120,12,28,0.78) 0%, rgba(156,16,40,0.70) 45%, rgba(52,5,14,0.95) 100%)" }}
        />
        ...
        <div className="absolute top-0 left-0 right-0 flex items-center px-4 pt-4">
          ...
          <div className="flex-1 flex justify-center">
            <div className="flex items-center gap-2">
              <img src={bingoLogo} alt="Bingo" className="h-8 w-8 rounded-md object-contain" />
              <span className="text-white text-sm font-bold">Bingo</span>
            </div>
          </div>
          <div className="w-9" />
        </div>
